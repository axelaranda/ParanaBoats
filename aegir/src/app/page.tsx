...
export default function Home() {
  ...
  return (
    ...
    <main className="min-h-dvh !pb-28">
      <h2 className="w-fit mx-auto font-poppins text-3xl md:text-4xl lg:text-5xl bg-custom-light p-2 border border-transparent rounded-xl text-center">Deslizá hacia abajo</h2>
