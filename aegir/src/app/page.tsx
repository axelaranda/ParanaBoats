...
export default function Home() {
  ...
  return (
    ...
    <main className="min-h-dvh !pb-28">
      ...
      <h2 className="font-poppins text-3xl md:text-4xl lg:text-5xl text-center pb-6 px-4 mb-30 mt-10">Presioná o hace click en la imagen del barco que te interese para ver más fotos e información</h2>
