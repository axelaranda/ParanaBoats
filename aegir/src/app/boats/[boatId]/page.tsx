...
export default function BoatDetail() {
  ...
  return (
    ...
    <section className="border border-transparent rounded-xl flex flex-col max-w-[900px] w-full overflow-hidden shadow-sm bg-custom-light p-4 mb-20 m-3 sm:m-6">
