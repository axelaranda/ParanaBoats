    ...
    return (
      <section className="bg-custom-dark "> 
        ...
        <h2 className="text-custom-light font-roboto text-xl text-center mt-6 ml-6 mr-6">Mi principal preocupación es que puedas encontrar sin problemas la embarcación que tanto deseas y disfrutar de la mejor experiencia de compra, Paraná Boats: profesionalismo y transparencia</h2>
         ...
         <h2 className="text-custom-light font-roboto text-center mt-6 ml-6 mr-6">Mi nombre es Axel Aranda, estoy en contacto con el río desde los 3 días de vida cuando me llevaban a navegar en el Plenamar 27 de mi abuelo, empecé a navegar en optimist a los 9 años, empecé a competir a los 11, pasé también por láser -ahora llamada ILCA-, navegué en numerosos veleros lastrados y también fui instructor de optimist e ILCA; podría afirmar sin lugar a duda que soy un apasionado de la náutica</h2>

          <div className="text-center text-sm py-6 flex-1 font-roboto text-custom-light mt-12">
